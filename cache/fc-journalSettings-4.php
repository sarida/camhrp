<?php return array (
  ...
  'privacyStatement' => 
  array (
    'en_US' => 'The names and email addresses entered in this site will be used exclusively for the stated purposes of this site and will not be made available for any other purpose or to any other party.',
  ),
...
Cambodia Health Research Portal',
  ...
  'readerInformation' => 
  array (
    'en_US' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="/camhrp/camhrp/index.php/camhrp/user/register">Register</a> link at the top of the home page for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="/camhrp/camhrp/index.php/camhrp/about/submissions#privacyStatement">Privacy Statement</a>, which assures readers that their name and email address will not be used for other purposes.',
  ),
  'authorInformation' => 
  array (
    'en_US' => 'Interested in submitting to this journal? We recommend that you review the <a href="/camhrp/camhrp/index.php/camhrp/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="/camhrp/camhrp/index.php/camhrp/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="/camhrp/camhrp/index.php/camhrp/user/register">register</a> with the journal prior to submitting or, if already registered, can simply <a href="/camhrp/camhrp/index.php/index/login">log in</a> and begin the five-step process.',
  ),
  ...
  'submissionFeeName' => 
  array (
    'en_US' => 'Proposal Review Fee',
  ),
  'submissionFeeDescription' => 
  array (
    'en_US' => 'Investigators are required to pay a Proposal Review Fee as part of the submission process to contribute to review and training costs. Students will be waived of this review fee.',
  ),
  'fastTrackFee' => 0,
  'fastTrackFeeName' => 
  array (
  ...
  'contactName' => 'Edouard Lavaud',
  'contactTitle' => 
  array (
    'en_US' => 'M.',
  ),
  'contactEmail' => 'lavaude@wpro.who.int',
  'contactPhone' => '',
  'contactFax' => '',
  'supportName' => 'ERC System Admin',
  'supportEmail' => 'lavaude@wpro.who.int',
  'supportPhone' => '',
  'sponsors' => 
  array (
  ),
  ...
  'title' => 
  array (
    'fr_CA' => 'Health Research Portal',
    'en_US' => 'Cambodia Health Research Portal',
  ),
  'volumePerYear' => 0,
  'issuePerVolume' => 0,
  ...
  'authorGuidelines' => 
  array (
    'en_US' => 'Before commencing the submission process, please make sure that you have read the <a title="WPRO ERC Standard Operating Procedures" href="/public/WPRO_ERC_SOP_Final201_web.pdf" target="_blank">WPRO ERC Standard Operating Procedures.</a>',
  ),
  ...
  array (
    ...
    array (
      ...
      array (
        'order' => '1',
        'content' => 'I agree to provide final report of the research study (both electronic and a hard copy) no later than 12 months of completion of data collection/field work to MoH.',
      ),
      1 => 
      array (
        'order' => '2',
        'content' => 'I agree to provide complete raw data set used for final analysis of the research study (both electronic and a hard copy) no later than 12 months of completion of data collection /field work to MoH.',
      ),
    ),
  ),
