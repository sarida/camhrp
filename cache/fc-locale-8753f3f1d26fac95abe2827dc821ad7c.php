<?php return array (
  ...
  'proposal.scientificTitle' => 'Prposal title',
  ...
  'proposal.fundsRequiredKHR' => 'Khmer Riel',
...
•	to take responsibility for the accuracy of trial registration information submitted.',
  ...
  'user.role.sectionEditors' => 'Ethics Committees Secretaries',
...
<p>The system could not automatically overwrite the configuration file. To apply your configuration changes you must open <tt>config.inc.php</tt> in a suitable text editor and replace its contents with the contents of the text field below.</p>',
  ...
  'manager.setup.reviewProcessEmailDescription' => 'The NECHR IRB Chair sends to the NECHR Members the request to review with the proposal attached to the email. NECHR Members email the IRB Chair their assent (or regrets), as well as the review and recommendation. The IRB Chair enters the NECHR Member\'s assent (or regrets), as well as the review and recommendation on the proposal\'s Review page, to record the review process.',
...
Active is how many reviews are currently being considered or underway.',
  ...
  'reviewer.article.notifyEditorA' => 'Notify the IRB Chair',
...
<li>Use <strong>*</strong> in a term as a wildcard to match any sequence of characters; e.g., <em>soci* morality</em> would match documents containing "sociological" or "societal"</li>
  ...
  'about.journalContact' => 'The National Ethics Committee for Health Research',
...
Validation may fail on search URLs that require posted form data.',
  ...
  'notification.type.reviewAssignment' => 'You have been assigned to review the proposal: "{$param}". Please specify if you are able to do the review.',
