<?php return array (
  'user.affiliation' => 'Institutional Affiliation',
  'user.uhsStudent' => 'UHS Student',
  'user.studentId' => 'Student ID',
  'user.tel' => 'Phone number',
  'user.affiliation.description' => '(institution, e.g. "Univesrity of Health Sciences, Phonm Penh")',
  ...
  'user.biography' => 'Official Designation or Title or Position',
  ...
  'user.phone' => 'Phone',
  'user.phoneInstruct' => 'Please include the country and area codes.',
  ...
  'user.profile.form.affiliationRequired' => 'The affiliation is required.',
  'user.profile.form.phoneRequired' => 'The phone number is required.',
  'user.profile.form.mailingAddressRequired' => 'The mailing address is required.',
  'user.profile.form.countryRequired' => 'The country of usual residence is required.',
  ...
  'user.profile.form.healthAffiliationRequired' => 'Please select Yes or No (Yes if health-affiliated)',
  'user.profile.form.wproAffiliationRequired' => 'Please select Yes or No (Yes if WPRO-affiliated).',
  'user.profile.form.healthAffiliation' => 'Is user health-affiliated?',
  'user.profile.form.wproAffiliation' => 'Is user WPRO-affiliated?',
  'user.profile.healthWproAffiliation' => 'Health / WPRO Affiliation',
  'user.profile.healthAffiliated' => 'Health-affiliated',
  'user.profile.nonHealth' => 'Non-health',
  'user.profile.wproAffiliated' => 'WPRO-affiliated',
  'user.profile.nonWpro' => 'non-WPRO',
  ...
  'user.role.reviewers' => 'Ethics Committees Members',
  'user.role.technicalReviewers' => 'Technical Reviewers',
  'user.role.siteAdmin' => 'Site Administrator',
  'user.role.siteAdmins' => 'Site Administrators',
  'user.roles' => 'Roles',
  'user.salutation' => 'Surname',
  'user.salutation.dr' => 'Dr.',
  'user.salutation.prof' => 'Prof.',
  ...
  'user.register.completeForm' => 'Fill in this form to register to the Cambodia Health Research Portal.',
); ?>