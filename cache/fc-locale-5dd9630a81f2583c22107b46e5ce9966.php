<?php return array (
  'manager.emails.confirmResetAll' => 'Are you sure you want to reset all email templates in this site? You will lose any customizations you have made.',
  'manager.files.note' => 'Note: The Files Browser is an advanced feature that allows the files and directories associated with a site to be viewed and manipulated directly.',
  'manager.groups' => 'Masthead',
  'manager.groups.publishEmails' => 'Publish member email addresses',
  'manager.groups.context.editorialTeam' => 'Have title appear under About the Site',
  'manager.groups.context.editorialTeam.short' => 'Secretariat',
  'manager.groups.context.people' => 'Have title appear as its own category under People',
  ...
  'manager.groups.enableBoard' => 'The Site Manager creates titles and adds people under each title.',
  'manager.groups.enableBoard.description' => 'Under <a href="{$aboutEditorialTeamUrl}">People</a> in About the Site:',
  'manager.groups.noneCreated' => 'No ERC have been created.',
  'manager.journalManagement' => 'Site Management',
  ...
  'manager.payment.authorFees' => 'Proposal Review Fee',
  'manager.payment.authorFeesDescription' => 'Selected options, along with their descriptions and fees (which can be edited below), will appear in Step 1 of the submission process and in About the Site under Submissions, as well as at points where payment is required.',
  ...
  'manager.payment.generalFeesDescription' => 'The Association Membership will appear in About the Site under Policies, and the donations link will appear above the search function in the right-hand frame.',
  ...
  'manager.payment.options.acceptSubscriptionPayments' => 'This will activate payments for Subscriptions, where types, cost, duration and subscriptions are managed by the Site (Subscription) Manager.',
  ...
  'manager.payment.paymentSolved' => 'Payment issue solved',
  'manager.payment.paymentReceived' => 'Payment received in cash or cheque',
  'manager.payment.paymentReceivedConfirm' => 'Please be sure you received the payment.',
  'manager.payment.paymentWaived' => 'Waiver by the IRB Chair',
  'manager.payment.paymentWaivedConfirm' => 'Are you sure to waive this payment?',
  'manager.payment.paymentExempted' => 'Exempt of fee (student research)',
  'manager.payment.paymentConfirm' => 'Please confirm the reception or the waive of the payment',
  'manager.payment.paymentDate' => 'Date confirmed',
  ...
  'manager.payment.readerFeesDescription' => 'Selected options, along with their descriptions and fees (which can be edited below), will appear in About the Site under Policies, as well as at points where payment is required.',
  'manager.payment.records' => 'Records',
  'manager.payments' => 'Payments',
  'manager.payment.userName' => 'Payment ID',
  'manager.people.allEnrolledUsers' => 'Users Enrolled in the NECHR System',
  'manager.people.allJournals' => 'All Sites',
  'manager.people.allSiteUsers' => 'Enrol a User from this Site in the NECHR System',
  'manager.people.showNoRole' => 'Users with restricted access (no role)',
  ...
  'manager.plugins.deleteError' => 'Plugin could not be deleted from the file system. This may be a permissions problem. Please make sure that the web server is able to write to the plugins directory (including subdirectories) but don\'t forget to secure it again later.',
  ...
  'manager.setup.doiReassign' => 'Reassign DOIs',
  'manager.setup.doiReassign.description' => 'If you change your DOI configuration, DOIs that have already been assigned will not be affected. Once the DOI configuration is saved, use this button to clear all existing DOIs so that the new settings will take effect with existing articles.',
  ...
  'manager.setup.journalFavicon' => 'Journal Favicon',
  'manager.setup.journalFaviconDescription' => 'Add a favicon for this journal to display alongside the navigation bar when users are visiting your site.',
  'manager.setup.journalFaviconInvalid' => 'Invalid favicon format. Accepted formats are .ico, .png, and .gif.',
  ...
  'manager.statistics.statistics.reviewers' => 'Ethics Committees Members',
  ...
  'manager.subscriptionPolicies.onlinePaymentNotificationsDescription' => 'Automated email notifications (available for editing by Journal Managers in OJS\'s Prepared Emails) can be sent to the Subscription Manager upon the completion of subscription online payments.',
