<?php /* Smarty version 2.6.26, created on 2012-05-11 18:25:16
         compiled from editor/submissionsUnassigned.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'editor/submissionsUnassigned.tpl', 16, false),array('function', 'sort_search', 'editor/submissionsUnassigned.tpl', 17, false),array('function', 'url', 'editor/submissionsUnassigned.tpl', 36, false),array('function', 'page_info', 'editor/submissionsUnassigned.tpl', 52, false),array('function', 'page_links', 'editor/submissionsUnassigned.tpl', 53, false),array('block', 'iterate', 'editor/submissionsUnassigned.tpl', 27, false),array('modifier', 'escape', 'editor/submissionsUnassigned.tpl', 31, false),array('modifier', 'date_format', 'editor/submissionsUnassigned.tpl', 32, false),array('modifier', 'truncate', 'editor/submissionsUnassigned.tpl', 35, false),array('modifier', 'strip_unsafe_html', 'editor/submissionsUnassigned.tpl', 36, false),)), $this); ?>
<div id="submissions">
<table width="100%" class="listing">
	...
	<tr class="heading" valign="bottom">
		...
		<td width="10%"><span class="disabled"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.date.yyyymmdd"), $this);?>
</span><br/>
<!-- <?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "submissions.submit",'sort' => 'submitDate'), $this);?>
--> </td> 
		...
		<td width="30%"><span class="disabled"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "article.authors"), $this);?>
</span><br/></td> <!-- <?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "article.authors",'sort' => 'authors'), $this);?>
</td> -->
		<td width="45%"><span class="disabled"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "article.title"), $this);?>
</span><br/></td> <!-- <?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "article.title",'sort' => 'title'), $this);?>
</td> -->
...
<?php else: ?>&mdash;<?php endif; ?></td>
	...
	<!-- --> <!-- Commented out by MSB -->
		...
		<td><?php if ($this->_tpl_vars['submission']->getResubmitCount()): ?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'submissionReview','path' => $this->_tpl_vars['submission']->getId()), $this);?>
...
</a><?php else: ?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'submission','path' => $this->_tpl_vars['submission']->getId()), $this);?>
" class="action"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['submission']->getLocalizedTitle())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : String::stripUnsafeHtml($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 60, "...") : $this->_plugins['modifier']['truncate'][0][0]->smartyTruncate($_tmp, 60, "...")); ?>
</a><?php endif; ?></td>
		<td><?php if ($this->_tpl_vars['submission']->getResubmitCount()): ?><?php echo $this->_tpl_vars['submission']->getResubmitCount(); ?>
