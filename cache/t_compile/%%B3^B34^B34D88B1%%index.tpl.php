<?php /* Smarty version 2.6.26, created on 2013-01-24 17:43:56
         compiled from user/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'user/index.tpl', 19, false),array('function', 'translate', 'user/index.tpl', 19, false),array('function', 'call_hook', 'user/index.tpl', 20, false),array('modifier', 'escape', 'user/index.tpl', 28, false),array('modifier', 'assign', 'user/index.tpl', 210, false),array('modifier', 'date_format', 'user/index.tpl', 261, false),)), $this); ?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.subscriptionManager"), $this);?>
		...
		<?php if ($this->_tpl_vars['isValid']['Editor'][$this->_tpl_vars['journalId']]): ?>
			<tr>
				...
				<td>&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'editor','op' => 'submissionsReport'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.coordinator"), $this);?>
</a></td>
				<td></td>
				<td align="center"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'editor','op' => 'submissionsReport'), $this);?>
">Report Generator</a></td>
				<td align="center"><!--<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'editor','op' => 'submissions','path' => 'submissionsInReview'), $this);?>
">Proposals</a>-->
				</td>
			</tr>
		<?php endif; ?> 
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.role.sectionEditor"), $this);?>
				...
				<td></td>
				<td align="center"><?php if ($this->_tpl_vars['sectionEditorSubmissionsCount'][0]): ?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.submissionsInReview"), $this);?>
 (<?php echo $this->_tpl_vars['sectionEditorSubmissionsCount'][0]; ?>
				...
				<td align="left"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'sectionEditor','op' => 'index','path' => 'submissionsArchives'), $this);?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.active"), $this);?>
 (<?php echo $this->_tpl_vars['authorSubmissionsCount'][0]; ?>
						...
						<span class="disabled"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.active"), $this);?>
 (0)</span>
					<?php endif; ?>
				</td>
				<td align="left">					<?php if ($this->_tpl_vars['authorSubmissionsCount'][1]): ?>
						<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'author','path' => 'completed'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.completed"), $this);?>
 (<?php echo $this->_tpl_vars['authorSubmissionsCount'][1]; ?>
)</a> 
					<?php else: ?>
						<span class="disabled"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.completed"), $this);?>
 (0)</span>
					<?php endif; ?>
				</td>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit"), $this);?>
		...
		<?php if ($this->_tpl_vars['isValid']['Reviewer'][$this->_tpl_vars['journalId']]): ?>
			<?php if (( ( $this->_tpl_vars['user']->isNechrMember() == true ) && ( $this->_tpl_vars['user']->isUhsMember() == true ) )): ?> <?php $this->assign('NECHR', "NECHR & UHS"); ?>
			<?php elseif ($this->_tpl_vars['user']->isNechrMember() == true): ?> <?php $this->assign('NECHR', 'NECHR Member'); ?>
			<?php elseif ($this->_tpl_vars['user']->isUhsMember() == true): ?> <?php $this->assign('NECHR', 'UHS'); ?>
			<?php else: ?> <?php $this->assign('NECHR', 'IRB Member'); ?> <?php endif; ?>
			
			<?php $this->assign('reviewerSubmissionsCount', $this->_tpl_vars['submissionsCount']['Reviewer'][$this->_tpl_vars['journalId']]); ?>
			<tr>
				<?php if ($this->_tpl_vars['NECHR'] == 'IRB Member'): ?>
				<td colspan="2">&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'reviewer'), $this);?>
"><?php echo $this->_tpl_vars['NECHR']; ?>
</a></td>
				<td align="right">
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.active"), $this);?>
 ...
 (0)</span>
				...
				<td align="center">
					<?php if ($this->_tpl_vars['reviewerSubmissionsCount'][1]): ?>
					<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'reviewer','path' => 'completed'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.completed"), $this);?>
 (<?php echo $this->_tpl_vars['reviewerSubmissionsCount'][1]; ?>
)</a>
					<?php else: ?>
						<span class="disabled"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.completed"), $this);?>
 (0)</span>
				...
				<?php else: ?>
				<td colspan="2">&#187; <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'reviewer','path' => 'fullReview'), $this);?>
"><?php echo $this->_tpl_vars['NECHR']; ?>
</a></td>
				<td align="left">
					<?php if ($this->_tpl_vars['reviewerSubmissionsCount'][2]): ?>
						<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journalPath'],'page' => 'reviewer','path' => 'fullReview'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.fullReview"), $this);?>
 (<?php echo $this->_tpl_vars['reviewerSubmissionsCount'][2]; ?>
)</a>
					<?php else: ?>
						<span class="disabled"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.queue.short.fullReview"), $this);?>
 (0)</span>
					<?php endif; ?>				
				</td>
				<?php endif; ?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.noRoles.submitArticle"), $this);?>
			...
			<li>
				...
				<?php if ($this->_tpl_vars['allowRegReviewer']): ?>
					<?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'user','op' => 'camhrp'), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'userHomeUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'userHomeUrl'));?>
