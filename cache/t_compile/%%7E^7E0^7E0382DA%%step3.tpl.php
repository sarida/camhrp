...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'manager/setup/step3.tpl', 12, false),array('function', 'fieldLabel', 'manager/setup/step3.tpl', 19, false),array('function', 'form_language_chooser', 'manager/setup/step3.tpl', 22, false),array('function', 'translate', 'manager/setup/step3.tpl', 23, false),array('function', 'load_url_in_div', 'manager/setup/step3.tpl', 334, false),array('function', 'fbvSelect', 'manager/setup/step3.tpl', 341, false),array('modifier', 'assign', 'manager/setup/step3.tpl', 21, false),array('modifier', 'escape', 'manager/setup/step3.tpl', 36, false),array('modifier', 'translate', 'manager/setup/step3.tpl', 341, false),)), $this); ?>
...
]" id="authorGuidelines" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['authorGuidelines'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea>
</p>
...
]" id="copyrightNotice" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['copyrightNotice'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></p>
...
]" id="competingInterestGuidelines" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['competingInterestGuidelines'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></p>
</div>
...
" size="50" maxlength="255" class="textField" />
			<br />
...
]" id="metaSubjectClassUrl" value="<?php if ($this->_tpl_vars['metaSubjectClassUrl'][$this->_tpl_vars['formLocale']]): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['metaSubjectClassUrl'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
<p><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.setup.registerJournalForIndexingDescription",'oaiUrl' => $this->_tpl_vars['oaiUrl']), $this);?>
</p>
</div>
...
<?php else: ?>
	...
	<div id="citationFilterSetupToggle" <?php if (! $this->_tpl_vars['metaCitations']): ?>style="visible: none"<?php endif; ?>>
		...
		<?php echo $this->_plugins['function']['fbvSelect'][0][0]->smartyFBVSelect(array('id' => 'metaCitationOutputFilterSelect','name' => 'metaCitationOutputFilterId','from' => $this->_tpl_vars['metaCitationOutputFilters'],'translate' => false,'selected' => ((is_array($_tmp=$this->_tpl_vars['metaCitationOutputFilterId'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)),'defaultValue' => "-1",'defaultLabel' => ((is_array($_tmp="manager.setup.filter.pleaseSelect")) ? $this->_run_mod_handler('translate', true, $_tmp) : Locale::translate($_tmp))), $this);?>
