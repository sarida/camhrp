<?php /* Smarty version 2.6.26, created on 2012-04-25 07:37:35
         compiled from manager/people/userProfile.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'manager/people/userProfile.tpl', 16, false),array('modifier', 'default', 'manager/people/userProfile.tpl', 29, false),array('modifier', 'nl2br', 'manager/people/userProfile.tpl', 69, false),array('modifier', 'concat', 'manager/people/userProfile.tpl', 93, false),array('modifier', 'to_array', 'manager/people/userProfile.tpl', 94, false),array('modifier', 'assign', 'manager/people/userProfile.tpl', 94, false),array('modifier', 'urldecode', 'manager/people/userProfile.tpl', 112, false),array('modifier', 'strip_unsafe_html', 'manager/people/userProfile.tpl', 120, false),array('modifier', 'date_format', 'manager/people/userProfile.tpl', 139, false),array('function', 'translate', 'manager/people/userProfile.tpl', 18, false),array('function', 'url', 'manager/people/userProfile.tpl', 20, false),array('function', 'icon', 'manager/people/userProfile.tpl', 95, false),)), $this); ?>
...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<tr valign="top">
		<td class="label"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.profile.healthWproAffiliation"), $this);?>
</td>
		<td class="value">
			<?php $this->assign('healthAffiliation', $this->_tpl_vars['user']->getLocalizedHealthAffiliation()); ?>
			<?php $this->assign('wproAffiliation', $this->_tpl_vars['user']->getLocalizedWproAffiliation()); ?>
			<?php if ($this->_tpl_vars['healthAffiliation'] == 'Yes'): ?>
				<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.profile.healthAffiliated"), $this);?>

			<?php else: ?>
				<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.profile.nonHealth"), $this);?>
				
			<?php endif; ?>
			,&nbsp;
			<?php if ($this->_tpl_vars['wproAffiliation'] == 'Yes'): ?>
				<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.profile.wproAffiliated"), $this);?>

			<?php else: ?>
				<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.profile.nonWpro"), $this);?>
