<?php /* Smarty version 2.6.26, created on 2012-04-17 16:33:57
         compiled from sectionEditor/setDueDate.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/setDueDate.tpl', 29, false),array('function', 'url', 'sectionEditor/setDueDate.tpl', 33, false),array('modifier', 'to_array', 'sectionEditor/setDueDate.tpl', 33, false),array('modifier', 'escape', 'sectionEditor/setDueDate.tpl', 37, false),array('modifier', 'date_format', 'sectionEditor/setDueDate.tpl', 42, false),)), $this); ?>
...
<!--		-->
<!--		<tr valign="top">-->
<!--		<td colspan="2"><h3><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.article.designateMeetingDate"), $this);?>
</h3></td>-->
<!--		</tr>-->
<!--		<tr valign="top">-->
<!--		<td colspan="2"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.article.designateMeetingDateDescription"), $this);?>
</td>-->
<!--		</tr>-->
<!--		-->
<!--		<tr valign="top">-->
<!--			<td width="20%" class="label"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "editor.article.meetingDate"), $this);?>
</td>-->
<!--			<td width="80%" class="value"><input type="text" class="textField" name="meetingDate" id="meetingDate" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['meetingDate'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d %I:%M %p") : smarty_modifier_date_format($_tmp, "%Y-%m-%d %I:%M %p")); ?>
