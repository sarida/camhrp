<?php /* Smarty version 2.6.26, created on 2012-04-17 16:52:39
         compiled from sectionEditor/submissionEventLog.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/submissionEventLog.tpl', 13, false),array('function', 'url', 'sectionEditor/submissionEventLog.tpl', 19, false),array('function', 'icon', 'sectionEditor/submissionEventLog.tpl', 55, false),array('function', 'page_info', 'sectionEditor/submissionEventLog.tpl', 77, false),array('function', 'page_links', 'sectionEditor/submissionEventLog.tpl', 78, false),array('modifier', 'assign', 'sectionEditor/submissionEventLog.tpl', 13, false),array('modifier', 'date_format', 'sectionEditor/submissionEventLog.tpl', 50, false),array('modifier', 'escape', 'sectionEditor/submissionEventLog.tpl', 51, false),array('modifier', 'concat', 'sectionEditor/submissionEventLog.tpl', 53, false),array('modifier', 'to_array', 'sectionEditor/submissionEventLog.tpl', 54, false),array('modifier', 'translate', 'sectionEditor/submissionEventLog.tpl', 54, false),array('modifier', 'strip_unsafe_html', 'sectionEditor/submissionEventLog.tpl', 60, false),array('modifier', 'truncate', 'sectionEditor/submissionEventLog.tpl', 60, false),array('block', 'iterate', 'sectionEditor/submissionEventLog.tpl', 48, false),)), $this); ?>
<?php echo ''; ?><?php echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.eventLog",'id' => $this->_tpl_vars['submission']->getWhoId($this->_tpl_vars['submission']->getLocale())), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'pageTitleTranslated') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'pageTitleTranslated'));?><?php echo ''; ?><?php $this->assign('whoId', $this->_tpl_vars['submission']->getWhoId($this->_tpl_vars['submission']->getLocale())); ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<?php else: ?>
	<tr>
		...
		<td colspan="2" align="right"><?php echo $this->_plugins['function']['page_links'][0][0]->smartyPageLinks(array('anchor' => 'eventLogEntries','name' => 'eventLogEntries','iterator' => $this->_tpl_vars['eventLogEntries']), $this);?>
</td>
	</tr>
<?php endif; ?>
</table>
