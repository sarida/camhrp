<?php /* Smarty version 2.6.26, created on 2013-01-15 13:18:17
         compiled from author/submission/management.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/submission/management.tpl', 12, false),array('function', 'url', 'author/submission/management.tpl', 33, false),array('function', 'icon', 'author/submission/management.tpl', 77, false),array('modifier', 'escape', 'author/submission/management.tpl', 19, false),array('modifier', 'strip_unsafe_html', 'author/submission/management.tpl', 27, false),array('modifier', 'to_array', 'author/submission/management.tpl', 33, false),array('modifier', 'concat', 'author/submission/management.tpl', 75, false),array('modifier', 'strip_tags', 'author/submission/management.tpl', 76, false),array('modifier', 'assign', 'author/submission/management.tpl', 76, false),array('modifier', 'date_format', 'author/submission/management.tpl', 82, false),array('modifier', 'nl2br', 'author/submission/management.tpl', 114, false),)), $this); ?>
<div id="submission">
...
?>
				<?php if ($this->_tpl_vars['suppFile']->getType() == 'Final Decision'): ?>
					<?php if ($this->_tpl_vars['suppFileDao']->getSetting($this->_tpl_vars['suppFile']->getSuppFileId(),'investigator') == 'hide'): ?>
						<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "article.suppFilesNotAuthorized"), $this);?>
...
</a>&nbsp;&nbsp;(<?php echo ((is_array($_tmp=$this->_tpl_vars['suppFile']->getTypeTranslated())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
)
					<?php endif; ?>
				<?php else: ?>
                    <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'downloadFile','path' => ((is_array($_tmp=$this->_tpl_vars['submission']->getArticleId())) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['suppFile']->getFileId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['suppFile']->getFileId()))), $this);?>
" class="file"><?php echo ((is_array($_tmp=$this->_tpl_vars['suppFile']->getFileName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
                    ...
                    <?php if ($this->_tpl_vars['canEditFiles']): ?>
                    	&nbsp;
                        <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'deleteSuppFile','path' => $this->_tpl_vars['suppFile']->getSuppFileId(),'articleId' => $this->_tpl_vars['submission']->getArticleId()), $this);?>
