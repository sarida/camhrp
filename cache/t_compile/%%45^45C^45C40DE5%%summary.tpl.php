...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/submission/summary.tpl', 12, false),array('function', 'url', 'author/submission/summary.tpl', 19, false),array('function', 'icon', 'author/submission/summary.tpl', 20, false),array('modifier', 'assign', 'author/submission/summary.tpl', 19, false),array('modifier', 'escape', 'author/submission/summary.tpl', 20, false),array('modifier', 'strip_unsafe_html', 'author/submission/summary.tpl', 28, false),array('modifier', 'concat', 'author/submission/summary.tpl', 39, false),array('modifier', 'to_array', 'author/submission/summary.tpl', 40, false),array('modifier', 'strip_tags', 'author/submission/summary.tpl', 40, false),)), $this); ?>
<div id="submission">
...
<table width="100%" class="data">
 ...
 <?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'mail','url' => $this->_tpl_vars['url']), $this);?>
			...
			<?php echo ((is_array($_tmp=$this->_tpl_vars['submission']->getFirstAuthor())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
