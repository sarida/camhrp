<?php /* Smarty version 2.6.26, created on 2013-01-16 14:45:25
         compiled from author/submit/step1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/submit/step1.tpl', 20, false),array('function', 'url', 'author/submit/step1.tpl', 24, false),array('function', 'fieldLabel', 'author/submit/step1.tpl', 51, false),array('function', 'html_options', 'author/submit/step1.tpl', 52, false),array('modifier', 'escape', 'author/submit/step1.tpl', 26, false),array('modifier', 'assign', 'author/submit/step1.tpl', 43, false),array('modifier', 'nl2br', 'author/submit/step1.tpl', 126, false),)), $this); ?>
...
<table class="data" width="100%">
	<tr valign="top">	
		...
		<?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'sectionId','required' => 'true','key' => "section.section"), $this);?>
</td>
...
<p><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit.submissionChecklistDescription"), $this);?>
	...
	<table width="100%" class="data">
		<tr valign="top">
			<td width="5%"><input type="checkbox" id="checklist" name="checklist[]" value="1"<?php if ($this->_tpl_vars['articleId'] || $this->_tpl_vars['submissionChecklist']): ?> checked="checked"<?php endif; ?> /></td>
			<td width="95%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit.submissionChecklist1"), $this);?>
</label></td>
		</tr>
	</table>
<div class="separator"></div>

<h3><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit.documentChecklist"), $this);?>
</h3>
<p><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit.documentChecklistDescription"), $this);?>
</p>
	<table width="100%" class="data">
		<tr valign="top">
			<td width="5%"><input type="checkbox" id="checklist" name="checklist[]" value="1"<?php if ($this->_tpl_vars['articleId'] || $this->_tpl_vars['submissionChecklist']): ?> checked="checked"<?php endif; ?> /></td>
			<td width="95%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit.documentChecklist1"), $this);?>
</label></td>
		</tr>
		<tr valign="top">
			<td width="5%"><input type="checkbox" id="checklist" name="checklist[]" value="1"<?php if ($this->_tpl_vars['articleId'] || $this->_tpl_vars['submissionChecklist']): ?> checked="checked"<?php endif; ?> /></td>
			<td width="95%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit.documentChecklist2"), $this);?>
</label></td>
		</tr>
		<tr valign="top">
			<td width="5%"><input type="checkbox" id="checklist" name="checklist[]" value="1"<?php if ($this->_tpl_vars['articleId'] || $this->_tpl_vars['submissionChecklist']): ?> checked="checked"<?php endif; ?> /></td>
			<td width="95%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit.documentChecklist3"), $this);?>
</label></td>
		</tr>
		<tr valign="top">
			<td width="5%"><input type="checkbox" id="checklist" name="checklist[]" value="1"<?php if ($this->_tpl_vars['articleId'] || $this->_tpl_vars['submissionChecklist']): ?> checked="checked"<?php endif; ?> /></td>
			<td width="95%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit.documentChecklist4"), $this);?>
</label></td>
		</tr>
	</table>
<div class="separator"></div>
