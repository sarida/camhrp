<?php /* Smarty version 2.6.26, created on 2013-01-25 15:31:45
         compiled from author/submit/step2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'author/submit/step2.tpl', 11, false),array('function', 'translate', 'author/submit/step2.tpl', 17, false),array('function', 'fieldLabel', 'author/submit/step2.tpl', 678, false),array('function', 'call_hook', 'author/submit/step2.tpl', 714, false),array('function', 'html_options', 'author/submit/step2.tpl', 984, false),array('modifier', 'assign', 'author/submit/step2.tpl', 11, false),array('modifier', 'escape', 'author/submit/step2.tpl', 20, false),)), $this); ?>
...
" width="20%" class="label">[?] <?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'nationwide','required' => 'true','key' => "proposal.nationwide"), $this);?>
                ...
                <td width="80%" class="value">
                	<input type="radio" name="nationwide[<?php echo ((is_array($_tmp=$this->_tpl_vars['eng'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
]" id="nationwide" value="Yes" <?php if ($this->_tpl_vars['nationwide'][$this->_tpl_vars['eng']] == 'Yes'): ?> checked="checked"<?php endif; ?>  /><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.yes"), $this);?>

                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="nationwide[<?php echo ((is_array($_tmp=$this->_tpl_vars['eng'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
]" id="nationwide" value="No" <?php if ($this->_tpl_vars['nationwide'][$this->_tpl_vars['eng']] == 'No'): ?> checked="checked"<?php endif; ?> /><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.no"), $this);?>
...
" class="button defaultButton"  onclick="return isNumeric(document.getElementById('fundsRequired'), 'The estimated budget should be numeric.')"/> <input type="button" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.cancel"), $this);?>
