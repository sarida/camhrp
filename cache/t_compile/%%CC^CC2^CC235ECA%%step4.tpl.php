<?php /* Smarty version 2.6.26, created on 2012-03-28 10:57:42
...
]" id="openAccessPolicy" rows="12" cols="50" class="textArea"<?php if ($this->_tpl_vars['publishingMode'] != @PUBLISHING_MODE_OPEN): ?> disabled="disabled"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['openAccessPolicy'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></p>
		</td>
	</tr>
	<tr>
...
]" id="pubFreqPolicy" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['pubFreqPolicy'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></p>
</div>
...
]" id="announcementsIntroduction" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['announcementsIntroduction'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></p>
...
]" id="copyeditInstructions" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['copyeditInstructions'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea>
</p>
...
]" id="layoutInstructions" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['layoutInstructions'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea>
</p>
...
]" id="refLinkInstructions" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['refLinkInstructions'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea>
...
]" id="proofInstructions" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['proofInstructions'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea>
</p>
</div>
</div>
