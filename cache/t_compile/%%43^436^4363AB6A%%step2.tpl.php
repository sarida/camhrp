...
]" id="focusScopeDesc" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['focusScopeDesc'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea>
</p>
</div>
...
]" id="reviewPolicy" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['reviewPolicy'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></p>
</div>
...
]" id="reviewGuidelines" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['reviewGuidelines'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></p>
</div>
...
]" id="privacyStatement" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['privacyStatement'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></p>
</div>
...
]" id="lockssLicense" rows="6" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['lockssLicense'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea>
	<br />
