<?php /* Smarty version 2.6.26, created on 2012-04-23 16:10:34
         compiled from citation/citationEditor.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'citation/citationEditor.tpl', 101, false),array('function', 'translate', 'citation/citationEditor.tpl', 164, false),array('function', 'load_url_in_div', 'citation/citationEditor.tpl', 264, false),)), $this); ?>
...
', function(jsonData) {
		...
		<?php if (! $this->_tpl_vars['introductionHide']): ?>
			...
			$('#introductionHide').click(function() {
				$.getJSON(
					'<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_COMPONENT,'component' => "api.user.UserApiHandler",'op' => 'setUserSetting'), $this);?>
