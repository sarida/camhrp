<?php /* Smarty version 2.6.26, created on 2012-12-05 00:11:17
         compiled from payments/paymentSettings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'payments/paymentSettings.tpl', 17, false),array('function', 'translate', 'payments/paymentSettings.tpl', 17, false),array('function', 'fieldLabel', 'payments/paymentSettings.tpl', 29, false),array('function', 'form_language_chooser', 'payments/paymentSettings.tpl', 32, false),array('function', 'html_options', 'payments/paymentSettings.tpl', 50, false),array('modifier', 'assign', 'payments/paymentSettings.tpl', 31, false),array('modifier', 'escape', 'payments/paymentSettings.tpl', 68, false),)), $this); ?>
...
<table width="100%" class="data">
	<tr>
		<td class="label" width="20%"><input type="checkbox" name="journalPaymentsEnabled" id="journalPaymentsEnabled" value="1"<?php if ($this->_tpl_vars['journalPaymentsEnabled']): ?> checked="checked"<?php endif; ?> /></td>
...
<table width="100%" class="data">
<tr>
	<td width="20%"><input type="checkbox" name="submissionFeeEnabled" id="submissionFeeEnabled" value="1"<?php if ($this->_tpl_vars['submissionFeeEnabled']): ?> checked="checked"<?php endif; ?> /></td>
	<td width="80%"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'submissionFeeEnabled','key' => "manager.payment.options.submissionFee"), $this);?>
</td>		
</tr>
<tr>
...
<tr>
	<td width="20%"><input type="checkbox" name="fastTrackFeeEnabled" id="fastTrackFeeEnabled" value="1"<?php if ($this->_tpl_vars['fastTrackFeeEnabled']): ?> checked="checked"<?php endif; ?> /></td>
	<td width="80%"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'fastTrackFeeEnabled','key' => "manager.payment.options.fastTrackFee"), $this);?>
</td>		
</tr>
<tr>
...
<tr>
	<td width="20%"><input type="checkbox" name="publicationFeeEnabled" id="publicationFeeEnabled" value="1"<?php if ($this->_tpl_vars['publicationFeeEnabled']): ?> checked="checked"<?php endif; ?> /></td>
	<td width="80%"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'publicationFeeEnabled','key' => "manager.payment.options.publicationFee"), $this);?>
</td>		
</tr>
<tr>
...
<table width="100%" class="data">
<tr>
	<td class="value" width="20%"><input type="checkbox" name="acceptSubscriptionPayments" id="acceptSubscriptionPayments" value="1"<?php if ($this->_tpl_vars['acceptSubscriptionPayments']): ?> checked="checked"<?php endif; ?> /></td>
	<td class="label" width="80%"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'acceptSubscriptionPayments','key' => "manager.payment.options.acceptSubscriptionPayments"), $this);?>
</td>
</tr>
<tr>
	<td width="20%"><input type="checkbox" name="purchaseArticleFeeEnabled" id="purchaseArticleFeeEnabled" value="1"<?php if ($this->_tpl_vars['purchaseArticleFeeEnabled']): ?> checked="checked"<?php endif; ?> /></td>
	<td width="80%"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'purchaseArticleFeeEnabled','key' => "manager.payment.options.purchaseArticleFee"), $this);?>
</td>		
</tr>
<tr>
...
<tr>
	...
	<td class="label" width="80%"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'restrictOnlyPdf','key' => "manager.payment.options.onlypdf"), $this);?>
</td>
</tr>
</table>
</div>
...
<table width="100%" class="data">
<tr>
	<td width="20%"><input type="checkbox" name="membershipFeeEnabled" id="membershipFeeEnabled" value="1"<?php if ($this->_tpl_vars['membershipFeeEnabled']): ?> checked="checked"<?php endif; ?> /></td>
	<td width="80%"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'membershipFeeEnabled','key' => "manager.payment.options.membershipFee"), $this);?>
</td>		
</tr>
<tr>
...
<tr>
	<td width="20%"><input type="checkbox" name="donationFeeEnabled" id="donationFeeEnabled" value="1"<?php if ($this->_tpl_vars['donationFeeEnabled']): ?> checked="checked"<?php endif; ?> /></td>
	<td width="80%"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'donationFeeEnabled','key' => "manager.payment.options.donationFee"), $this);?>
</td>		
</tr>
<tr>
