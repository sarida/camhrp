...
function changePaymentMethod() {
	document.paymentSettingsForm.action="'; ?>
...
<form method="post" name="paymentSettingsForm" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'savePayMethodSettings'), $this);?>
">
