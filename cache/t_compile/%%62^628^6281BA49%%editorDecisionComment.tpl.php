<?php /* Smarty version 2.6.26, created on 2012-08-06 17:09:36
         compiled from submission/comment/editorDecisionComment.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'submission/comment/editorDecisionComment.tpl', 32, false),array('function', 'url', 'submission/comment/editorDecisionComment.tpl', 38, false),array('function', 'fieldLabel', 'submission/comment/editorDecisionComment.tpl', 97, false),array('modifier', 'date_format', 'submission/comment/editorDecisionComment.tpl', 34, false),array('modifier', 'to_array', 'submission/comment/editorDecisionComment.tpl', 38, false),array('modifier', 'escape', 'submission/comment/editorDecisionComment.tpl', 38, false),array('modifier', 'strip_unsafe_html', 'submission/comment/editorDecisionComment.tpl', 45, false),array('modifier', 'nl2br', 'submission/comment/editorDecisionComment.tpl', 45, false),)), $this); ?>
...
<tr valign="top">
	<td width="20%">
		...
		<div class="commentRole"><strong><?php echo $this->_tpl_vars['submitter']->getFullName(); ?>
</strong><br/><?php echo $this->_tpl_vars['submitter']->getFunctions(); ?>
</div>
		<div class="commentDate"><?php echo ((is_array($_tmp=$this->_tpl_vars['comment']->getDatePosted())) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['datetimeFormatLong']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['datetimeFormatLong'])); ?>
</div>
	</td>
	<td width="80%">
...
?>
				...
				<?php $this->assign('submitter', $this->_tpl_vars['userDao']->getUser($this->_tpl_vars['comment']->getAuthorId())); ?>
					<tr valign="top">
						...
						<td>
							<?php if ($this->_tpl_vars['comment']->getCommentTitle()): ?>
								<div class="commentTitle"><?php if ($this->_tpl_vars['showReviewLetters']): ?>ຫົວຂໍ້<?php else: ?><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submission.comments.subject"), $this);?>
<?php endif; ?>: <?php echo ((is_array($_tmp=$this->_tpl_vars['comment']->getCommentTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</div>
							<?php endif; ?>
