<?php /* Smarty version 2.6.26, created on 2012-03-27 16:14:10
...
]" rows="3" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['description'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></p>
</div>
...
]" id="additionalHomeContent" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['additionalHomeContent'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></p>
</div>
</div>
<div class="separator"></div>
...
]" id="journalPageHeader" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['journalPageHeader'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></p>
</div>
</div>
<div class="separator"></div>
...
]" id="journalPageFooter" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['journalPageFooter'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></p>
</div>
...
<?php endforeach; else: ?>
	...
	<tr valign="top">
		...
		<td width="80%" class="value">
			<input type="text" name="navItems[<?php echo ((is_array($_tmp=$this->_tpl_vars['formLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
][0][url]" id="navItems-0-url" size="50" maxlength="255" class="textField" />
			<table width="100%">
				<tr valign="top">
					<td width="5%"><input type="checkbox" name="navItems[<?php echo ((is_array($_tmp=$this->_tpl_vars['formLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
]" id="readerInformation" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['readerInformation'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></p></div>
...
]" id="authorInformation" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['authorInformation'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></p></div>
...
]" id="librarianInformation" rows="12" cols="50" class="textArea"><?php echo ((is_array($_tmp=$this->_tpl_vars['librarianInformation'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea></p></div>
</div>
