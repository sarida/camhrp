<?php return array (
  ...
  'author.competingInterests' => 'Conflits&nbsp;d\'intérêts <a target="_new" class="action" href="{$competingInterestGuidelinesUrl}">Politique de CI</a>',
  ...
  'author.submit.start' => '1. Commencer',
  ...
  'author.submit.confirmation' => '5. Confirmer la soumission',
  'author.submit.cancelSubmission' => 'Vous pouvez terminer cette soumission plus tard en sélectionnant Soumissions actives à la Page d\'accueil de l\'auteur.',
  ...
  'author.submit.qualityForWaiver' => 'Veuillez envisager d\'être exempté des Frais de soumission d\'article pour cet article',
  ...
  'author.submissions.uploadCopyeditedVersion' => 'Télécharger le fichier révisé',
  ...
  'author.submit.howToSubmit' => 'Vous éprouvez des difficultés? Communiquez avec <a href="mailto:{$supportEmail}">{$supportName}</a> pour obtenir de l\'aide ({$supportPhone}).',
  'author.submit.howToSubmitNoPhone' => 'Vous éprouvez des difficultés? Communiquez avec <a href="mailto:{$supportEmail}">{$supportName}</a> pour obtenir de l\'aide.',
  ...
  'author.submit.selectSection' => 'Veuillez sélectionner une rubrique...',
  'author.submit.submissionChecklist' => 'Liste de vérification de la soumission',
  'author.submit.submissionChecklistDescription' => 'Indiquer que cette soumission est prête à être évaluée par la revue en sélectionnant tous les éléments suivants (des commentaires au rédacteur peuvent être ajoutés ci-dessous).',
  ...
  'author.submit.copyrightNoticeAgree' => 'Les auteurs acceptent les conditions de l\'Avis de droit d\'auteur, qui s\'appliqueront à cette soumission si et quand elle sera publiée par cette revue (des commentaires au rédacteur peuvent être ajoutés ci-dessous).',
  ...
  'author.submit.commentsForEditor' => 'Commentaires pour le Rédacteur',
  'author.submit.comments' => 'Saisir du texte (optionnel)',
  'author.submit.form.sectionRequired' => 'Veuillez sélectionner une rubrique de la revue appropriée pour cette soumission.',
  'author.submit.privacyStatement' => 'Déclaration de confidentialité de la revue',
  ...
  'author.submit.submissionSupportingAgenciesDescription' => 'Identifier les organismes qui ont fourni du financement ou du soutien pour le travail présenté dans cette soumission.',
  ...
  'author.submit.subjectClassInstructions' => 'Utiliser le système de classification par liens pour sélectionner les termes de la classification et, s\'il y a lieu, les numéros.',
  ...
  'author.submit.uploadSubmissionFile' => 'Télécharger le fichier de soumission',
  ...
  'author.submit.noSubmissionConfirm' => 'Êtes-vous certain de vouloir continuer sans télécharger le fichier de soumission?',
  'author.submit.supplementaryFilesInstructions' => 'Cette étape facultative permet l\'ajout de fichiers supplémentaires à la soumission. Les fichiers, qui peuvent être sous n\'importe quel format, peuvent comprendre (a) des instruments de recherche, (b) des ensembles de données se conformant aux conditions de la révision déontologique de la recherche de l\'étude, (c) des sources qui autrement ne seraient pas disponibles aux lecteurs, (d) des nombres et des tableaux qui ne peuvent être intégrés dans le texte en soi, ou autres documents qui ajoutent une contribution au travail.',
  'author.submit.supplementaryFiles.saveToUpload' => 'Cliquer sur Enregistrer pour télécharger le fichier (après cela, des fichiers supplémentaires peuvent être téléchargés).',
  'author.submit.forgottenSubmitSuppFile' => 'Êtes-vous certain de vouloir continuer sans télécharger le fichier supplémentaire que vous avez choisi?',
  ...
  'author.submit.uploadSuppFile' => 'Télécharger le fichier supplémentaire',
  ...
  'author.submit.supplementaryFileDataDescription' => 'Pour indexer ces documents supplémentaires, fournir les métadonnées suivantes pour chaque fichier supplémentaire téléchargé.',
  ...
  'author.submit.suppFile.contributorOrSponsor' => 'Contributeur ou organisme de soutien',
  'author.submit.suppFile.availableToPeers' => 'Présenter le fichier aux évaluateurs (sans métadonnées), de façon à ne pas compromettre l\'évaluation anonyme.',
  ...
  'author.submit.confirmationDescription' => 'Pour soumettre votre manuscrit à {$journalTitle}, cliquer sur Terminer la soumission. Le contact principal de la soumission recevra un accusé de réception par courriel et sera en mesure d\'afficher le progrès du processus éditorial de la soumission en se connectant dans le site Web de la revue. Merci de votre intérêt à publier dans {$journalTitle}.',
  ...
  'author.submit.expedite' => 'Si cette soumission est déjà dans un format qui lui permet d\'être publiée sans évaluation, révision ou mise en page supplémentaire, il est possible de la placer directement dans la dernière étape de la file d\'attente en <a href="{$expediteUrl}" class="action">Cliquant ici</a>. (Note : seuls les rédacteurs de revue ont cette option pour leurs soumissions.)',
  'author.article.uploadAuthorVersion' => 'Télécharger la version de l\'auteur',
  ...
  'author.submissions.queuedEditingProofread' => 'En révision : Correction d\'épreuves requise',
  ...
  'author.submit.submissionLocale' => 'Langue de la soumission',
  'author.submit.submissionLocaleDescription' => 'La revue accepte les soumissions dans plusieurs langues. Choisir la langue principale de la soumission à partir de la liste déroulante ci-dessous.',
